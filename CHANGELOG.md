...
- debounce all shade changes as a group, instead of by shade id
...
- restore Hoobs support by using `api.registerPlatform(PLUGIN_NAME, PLATFORM_NAME, HunterDouglasPlatform)`
